...
// changing a String:
	...
	println!("{}", str5); // ? Level 1 is finished - Rise up to Level 2
...
// Magician Merlin greets magician Gandalf with Hello, ??!
// Merlin
// Merlin
// Sauron
...
// M - e - r - l - i - n - ? / Level / 1 / is / finished / - / Rise / up / to / Level / 2 / 
